...
public class AssetDescriptors {
    ...
    public static final AssetDescriptor<Sound> LOSE_TAIL_SOUND =
            new AssetDescriptor<Sound>( AssetPaths.LOSE_TAIL_SOUND, Sound.class );

    public static final AssetDescriptor<Sound> SPEED_UP_SOUND =
            new AssetDescriptor<Sound>( AssetPaths.SPEED_UP_SOUND, Sound.class );

    public static final AssetDescriptor<Sound> SPEED_DOWN_SOUND =
            new AssetDescriptor<Sound>( AssetPaths.SPEED_DOWN_SOUND, Sound.class );
